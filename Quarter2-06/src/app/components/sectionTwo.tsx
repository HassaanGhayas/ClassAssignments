export default function SectionTwo() {
  return (
    <section className="px-[20px] my-[80px] max-w-[1200px] mx-auto">
      <div className="flex items-center justify-between">
        <span className="sm:text-[24px] text-[20px]">Browse By Category</span>
        <span className="flex">
          <svg
            width="32"
            height="32"
      ...
      <div className="grid-layout">
        <div className="h-[128px] flex flex-col items-center justify-center bg-lightBlue rounded-2xl">
          <svg
            width="48"
            height="48"
            viewBox="0 0 48 48"
        ...
        <div className="h-[128px] flex flex-col items-center justify-center bg-lightBlue rounded-2xl">
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
          >
            <g clipPath="url(#clip0_2603_1940)">
              <path
        ...
        <div className="h-[128px] flex flex-col items-center justify-center bg-lightBlue rounded-2xl">
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
          >
            <g clipPath="url(#clip0_2603_1937)">
              <path
        ...
        <div className="h-[128px] flex flex-col items-center justify-center bg-lightBlue rounded-2xl">
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
          >
            <g clipPath="url(#clip0_2603_1943)">
              <path
